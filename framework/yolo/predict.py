...
class YOLO(object):
    _defaults = {
        "model_path": '../../workspace/detection_model/out/trained_weights_final.h5',
        "anchors_path": '../../workspace/detection_model/model_data/yolo_anchors.txt',
        "classes_path": '../../workspace/detection_model/model_data/object_classes.txt',
        "score": 0.3,
        "iou": 0.3,
    ...
    def detect_image(self, image, only_boxes=False):
        start = timer()
